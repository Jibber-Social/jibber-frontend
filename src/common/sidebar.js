            ...
            <Col xs={12}>
              ...
              <div className='sidebar-nav-container'>
                <SidebarNav style={{marginBottom: 0}} ref={(c) => this._nav = c}>
                  ...
                  <SidebarNavItem glyph='icon-fontello-gauge' name='Historik' href='/historik' />
                  <SidebarNavItem glyph='icon-fontello-gauge' name='Konton' href='/konton' />
                  <SidebarNavItem glyph='icon-fontello-gauge' name='Installationskod' href='/installationskod' />
                  <SidebarNavItem glyph='icon-fontello-gauge' name='Inställningar' href='/installningar' />
                </SidebarNav>
              </div>
            </Col>
          </Row>
